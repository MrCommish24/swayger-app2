...
VALUES
  ...
  ('nfl_slate_late_team_points', 'nfl', 'nfl_sunday_slate', 'halftime', 'Which Late Slate team scores the most points?', '["{{SLATE_TEAMS}}"]'::jsonb, 'End Late Slate', 11, true, true),
  ('nfl_slate_late_highest_total_game', 'nfl', 'nfl_sunday_slate', 'halftime', 'Which Late Slate game has the highest combined score?', '["{{SLATE_LATE_GAMES}}"]'::jsonb, 'End Late Slate', 12, true, true),
  ('nfl_slate_late_overtime', 'nfl', 'nfl_sunday_slate', 'halftime', 'Will any Late Slate game go to overtime?', '["Yes","No"]'::jsonb, 'End Late Slate', 13, true, true),
  ('nfl_slate_late_fewest_points_allowed', 'nfl', 'nfl_sunday_slate', 'halftime', 'Which Late Slate team allows the fewest points?', '["{{SLATE_TEAMS}}"]'::jsonb, 'End Late Slate', 14, true, true),
  ('nfl_slate_snf_winner', 'nfl', 'nfl_sunday_slate', 'fourth', 'Who wins Sunday Night Football?', '["{{TEAM_A}}","{{TEAM_B}}"]'::jsonb, 'End Game', 15, true, true),
  ('nfl_slate_snf_first_score', 'nfl', 'nfl_sunday_slate', 'fourth', 'Which team scores first on Sunday Night?', '["{{TEAM_A}}","{{TEAM_B}}"]'::jsonb, 'Opening Drive', 16, true, true),
  ('nfl_slate_snf_margin', 'nfl', 'nfl_sunday_slate', 'fourth', 'What is the Sunday Night final margin?', '["1–7","8–14","15+","Tie / Multiple tied"]'::jsonb, 'End Game', 17, true, true)
