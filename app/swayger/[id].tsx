...
const styles = StyleSheet.create({
  ...
  swaygerTitle: { fontFamily: "BarlowCondensed_800ExtraBold", fontSize: 28, color: Colors.dark.text },
  ...
  pickCardYou: { borderColor: Colors.dark.tint, backgroundColor: "rgba(67, 97, 238, 0.05)" },
  ...
  rematchWaitingCard: {
    alignItems: "center", gap: 8, backgroundColor: "rgba(67, 97, 238, 0.06)",
    borderRadius: 14, padding: 20, borderWidth: 1, borderColor: "rgba(67, 97, 238, 0.15)",
  },
