...
export const MM_ROUNDS: MMRound[] = [
  // ── FIRST FOUR ────────────────────────────────────────────
  {
    ...
    featured: [
      {
        id: "ff-1",
        teamA: { name: "UMBC", seed: 16 },
        teamB: { name: "Howard", seed: 16 },
        region: "Midwest",
        prompt: "The winner earns the honor of facing #1 Michigan. Who survives the play-in?",
      ...
      {
        id: "ff-3",
        teamA: { name: "Texas", seed: 11 },
        teamB: { name: "NC State", seed: 11 },
        region: "West",
        prompt: "NC State has First Four–to-champion DNA. Can they do it again vs. Texas?",
