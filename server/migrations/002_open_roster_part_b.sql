-- ============================================================
-- Migration 002 — Part B: UPDATE RPC
-- Run this block AFTER Part A succeeds.
-- Safe to re-run (CREATE OR REPLACE).
-- NOTE: GRANT removed — SECURITY DEFINER makes it unnecessary.
-- ============================================================
...
-- Verify the new RPC is in place:
-- With a random UUID, it should say 'Fantasy league not found' (not 'Season not found').
