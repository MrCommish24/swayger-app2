  ...
  if (roundId === "elite-8") {
    ...
    const e8All: RankedMatchup[] = [
      ...
      },
      {
        ...
        teamB: "Tennessee Volunteers",   seedB: 2,
        region: "Midwest", rank: 0,
        favoriteTeam: "Michigan Wolverines",   favoriteSeed: 1,
        underdogTeam: "Tennessee Volunteers",  underdogSeed: 2,
        upsetProbability: 0.42,
        spread: 2.0, overUnder: 143, underdogMoneyline: 150,
        gameDate: "Mar 29", site: "Chicago, IL",
        oddsSource: "seed-based",
        keyStat: "Michigan beat Alabama, Tennessee beat Iowa State — this is a 1v2 showdown with Final Four on the line",
      },
      {
      ...
      },
      {
        ...
        upsetProbability: 0.40,
        spread: 4.0, overUnder: 140, underdogMoneyline: 165,
        gameDate: "Mar 28", site: "Houston, TX",
        oddsSource: "seed-based",
        keyStat: "Iowa upset #1 Florida and #4 Nebraska — Illinois upset #2 Houston. Someone's Cinderella run ends here.",
      },
    ];
